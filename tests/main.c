...
int main(int argc, char* argv[MUNIT_ARRAY_PARAM(argc + 1)]) {
    ...
    MunitSuite all_test_suites[] = {
        ...
        interpolate_test_suite, conversions_test_suite,
        balance_test_suite,     bq_test_suite,
        curve_test_suite,       line_test_suite,
        rc_test_suite,          svf_test_suite,
        xfade_test_suite,       delay_test_suite,
        stft_test_suite,        lag_test_suite,
        follow_test_suite,      samph_test_suite,
        pblep_test_suite,       phasor_test_suite,
        tabread_test_suite,     oscil_test_suite,
        ft_sinesum_test_suite,  ft_chebpoly_test_suite,
        conv_test_suite,        {NULL, NULL, NULL, 1, MUNIT_SUITE_OPTION_NONE},
    };
