...
static MunitTest test_interpolate_module[] = {
    ...
    {"/lerp/endpoints", test_lerp_endpoints, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/lerp/exact", test_lerp_exact_matches, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/lerp/linear_segments", test_lerp_linear_segments, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {"/lerp/monotonic", test_lerp_monotonic, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
