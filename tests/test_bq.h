...
static MunitTest test_bq_module[] = {
    ...
    {"/non_resonant_tick_block_linkwitzriley",
     ...
     NULL},
    {"/test_bq_resonant_init", test_bq_resonant_init, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {"/test_bq_resonant_tick_block_lpf", test_bq_resonant_tick_block_lpf, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {"/test_bq_resonant_tick_block_hpf", test_bq_resonant_tick_block_hpf, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {"/test_bq_resonant_tick_block_bpf", test_bq_resonant_tick_block_bpf, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {"/test_bq_resonant_tick_block_bsf", test_bq_resonant_tick_block_bsf, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {"/test_bq_resonant_tick_block_reson", test_bq_resonant_tick_block_reson, NULL,
     NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/test_bq_resonant_tick_block_apf", test_bq_resonant_tick_block_apf, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {"/test_bq_para_eq_init", test_bq_para_eq_init, NULL, NULL, MUNIT_TEST_OPTION_NONE,
     NULL},
    {"/test_bq_para_eq_tick_block_lshlf", test_bq_para_eq_tick_block_lshlf, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {"/test_bq_para_eq_tick_block_hshlf", test_bq_para_eq_tick_block_hshlf, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {"/test_bq_para_eq_tick_block_peak", test_bq_para_eq_tick_block_peak, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
